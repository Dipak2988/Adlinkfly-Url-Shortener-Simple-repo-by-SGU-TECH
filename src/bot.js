...
bot.onText(/\/start/, (msg) => {
  ...
  const welcomeMessage = `😇 Hello, ${username}!\n\n`
    + 'Welcome to the BongURL URL Shortener Bot!\n'
    + 'You can use this bot to shorten URLs using the bongurl.in api service.\n\n'
    + 'To shorten a URL, just type or paste the URL directly in the chat, and the bot will provide you with the shortened URL.\n\n'
    + 'If you haven\'t set your BongURL API token yet, use the command:\n/setapi YOUR_BongURL_API_TOKEN\n\n'
    + 'How To Use Me 👇👇 \n\n'
  + '✅1. Got To https://bongurl.in & Complete Your Registration.\n\n'
  + '✅2. Then Copy Your API Key from here https://bongurl.in/member/tools/api Copy Your API Only. \n\n'
